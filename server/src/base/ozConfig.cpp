...
bool ConfigItem::BooleanValue() const
{
    ...
    {
        Error( "Attempt to fetch boolean value for %s, actual type is %s. Try running 'ozupdate.pl -f' to reload config.", name, type );
        exit( -1 );
    }
...
int ConfigItem::IntegerValue() const
{
    ...
    {
        Error( "Attempt to fetch integer value for %s, actual type is %s. Try running 'ozupdate.pl -f' to reload config.", name, type );
        exit( -1 );
    }
...
double ConfigItem::DecimalValue() const
{
    ...
    {
        Error( "Attempt to fetch decimal value for %s, actual type is %s. Try running 'ozupdate.pl -f' to reload config.", name, type );
        exit( -1 );
    }
...
const char *ConfigItem::StringValue() const
{
    ...
    {
        Error( "Attempt to fetch string value for %s, actual type is %s. Try running 'ozupdate.pl -f' to reload config.", name, type );
        exit( -1 );
    }
