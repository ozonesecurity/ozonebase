...
#define ZM_AUDIO_STREAMING 218
#define ZM_DYN_CAPTURE_CARD_TYPE 219


#define ZM_MAX_CFG_ID 219
...
#define ZM_CFG_ASSIGN_LIST \
    ...
    opt_detect = (bool)config.Item( ZM_OPT_DETECT );\
    ...
    audio_streaming = (bool)config.Item( ZM_AUDIO_STREAMING );\
    dyn_capture_card_type = (const char *)config.Item( ZM_DYN_CAPTURE_CARD_TYPE );\
