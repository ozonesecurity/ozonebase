...
MotionFrame::MotionFrame( MotionDetector *provider, FramePtr parent, uint64_t id, uint64_t timestamp, const ByteBuffer &buffer, bool alarmed, const MotionData *motionData ) :
...
MotionFrame::MotionFrame( MotionDetector *provider, FramePtr parent, bool alarmed, const MotionData *motionData ) :
