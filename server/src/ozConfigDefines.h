...
#define ZM_CFG_ASSIGN_LIST \
    ...
    path_ozs = (const char *)config.Item( ZM_PATH_ZMS );\
    ...
    eyeoz_debug = (bool)config.Item( ZM_EYEZM_DEBUG );\
    eyeoz_log_to_file = (bool)config.Item( ZM_EYEZM_LOG_TO_FILE );\
    eyeoz_log_file = (const char *)config.Item( ZM_EYEZM_LOG_FILE );\
    eyeoz_event_vcodec = (const char *)config.Item( ZM_EYEZM_EVENT_VCODEC );\
    eyeoz_feed_vcodec = (const char *)config.Item( ZM_EYEZM_FEED_VCODEC );\
    eyeoz_h264_default_br = (const char *)config.Item( ZM_EYEZM_H264_DEFAULT_BR );\
    eyeoz_h264_default_evbr = (const char *)config.Item( ZM_EYEZM_H264_DEFAULT_EVBR );\
    eyeoz_h264_timeout = (const char *)config.Item( ZM_EYEZM_H264_TIMEOUT );\
    eyeoz_seg_duration = (const char *)config.Item( ZM_EYEZM_SEG_DURATION );\
